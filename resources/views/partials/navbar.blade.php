            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                    <a href="{{ route('front.feature') }}"
                        class="dropdown-item {{ request()->is('feature') ? 'active' : '' }}">Feature</a>
                    <a href="{{ route('front.team') }}"
                        class="dropdown-item {{ request()->is('team') ? 'active' : '' }}">Our Doctor</a>
                    <a href="{{ route('front.appointment') }}"
                        class="dropdown-item {{ request()->is('appointment') ? 'active' : '' }}">Appointment</a>
                    <a href="{{ route('front.testimonial') }}"
                        class="dropdown-item {{ request()->is('testimonial') ? 'active' : '' }}">Testimonial</a>
                    <a href="{{ route('front.page404') }}"
                        class="dropdown-item {{ request()->is('page404') ? 'active' : '' }}">404 Page</a>
                </div>
            </div>
